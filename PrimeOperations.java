...
public class PrimeOperations {
	...
	private class Pair<T> {
		public T p1;
		public T p2;
		// Constructor to set both variables
	...
	public void printHexes()
	{
		...
		for(int i = 0; i < hexList.size(); ++i) {
			BigInteger lowPair1 = hexList.get(i).p1.p1;
			BigInteger lowPair2 = hexList.get(i).p1.p2;
			BigInteger highPair1 = hexList.get(i).p2.p1;
			BigInteger highPair2 = hexList.get(i).p2.p2;
			BigInteger cross1 = hexList.get(i).p1.p1.add(BigInteger.valueOf(1));
			BigInteger cross2 = hexList.get(i).p2.p1.add(BigInteger.valueOf(1));
